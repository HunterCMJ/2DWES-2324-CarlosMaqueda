...
(dni VARCHAR(9),
 ...
 CONSTRAINT fk_emple_dpto FOREIGN KEY (cod_dpto)
                          REFERENCES departamento(cod_dpto))
 ENGINE=InnoDB;
						 
INSERT INTO departamento (cod_dpto,nombre_dpto) VALUES ('D001','CONTABILIDAD');						 
...
fecha_ini DATE,
fecha_fin DATE,
CONSTRAINT pk_emple_dpto PRIMARY KEY(dni,cod_dpto,fecha_ini),
